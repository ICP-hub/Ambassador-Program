...
export const WalletBalance = ({
  ...
  return (
    <section className="flex relative flex-col items-center max-w-full w-[55%]">
      <div className="self-stretch px-9 py-6 rounded-3xl border-[#9173FF] border-solid border-[3px] max-md:px-5 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="w-[22%] max-md:ml-0 max-md:w-full">
            <h2 className="text-4xl font-semibold  text-white  max-md:mt-10 max-md:text-3xl ">
              Smart <br />
              Wallet
            </h2>
          </div>
          <div className="flex items-center gap-5 ml-4 w-[78%] max-md:ml-0 max-md:w-full">
            <img src={walletIcon} alt="wallet" className="w-[98px] h-[80px] " />
            {/* {ledger ? (
              <button
            ...
            <div className=" cursor-pointer transition-all  bg-[#9173ff6d] duration-500 text-white font-semibold text-2xl py-5 w-full rounded-2xl flex justify-center items-center">
