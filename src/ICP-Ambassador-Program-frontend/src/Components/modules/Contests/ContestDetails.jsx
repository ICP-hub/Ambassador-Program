...
const Contest_Details = ({ closeContestDetails, contests }) => {
  ...
  const [tasks, setTasks] = useState(contests.tasks);
  const hubicons = {
    platform: HUB,
    platform_logo:
      "https://seeklogo.com/images/I/internet-computer-icp-logo-83628B267C-seeklogo.com.png",
  ...
  return (
    <div className="h-full    lg:w-[400px] sm:w-full rounded-md bg-[#16161a] font-poppins">
      <div className="flex justify-center items-center w-full ">
        <div className=" flex flex-col gap-16 justify-start items-start w-full  h-full ">
          <div className="flex flex-col items-center justify-center w-full gap-10">
            <div
              className="flex flex-col gap-4 w-full h-52 rounded-md"
              style={{
              ...
              <div className="flex justify-around ">
                <div className="mb-4">
                  {img?.length > 0 ? (
                    <img
                      src={img}
                      alt={title}
                      className="lg:w-44 lg:h-44 sm:w-44 sm:h-20 object-cover rounded-lg"
                    />
                  ) : (
                ...
                <div className="flex flex-col gap-4 justify-start items-start">
                  ...
                  <div className="flex items-center gap-3 ">
                    <img
                      src={hubicons.platform_logo}
                      alt={hubicons.platform}
          ...
          <div className="w-full flex flex-col gap-6 overflow-y-auto mb-5 p-2">
            {tasks.map((task, index) => {
              ...
              return (
                <div
                  className="flex flex-col gap-3 relative rounded-xl"
                ...
                >
                  ...
                  >
                    <Accordion
                      style={{ backgroundColor: "#1d1d21", color: "white" }}
                    >
                      <AccordionSummary
                        expandIcon={
                          <ExpandMoreIcon className="text-white lg:text-md sm:text-xs" />
                        }
                      ...
                      <AccordionDetails>
                        {!task.submitted ? (
                          <form
                            onSubmit={(e) => addSubmission(e, taskData.task_id)}
                          ...
                          >
                              ...
                              <>
                                ...
                                <div className="border border-gray-300 rounded-md custom-quill shadow-sm w-full">
                                  ...
                                  <textarea
                                    ...
                                    onChange={(e) =>
                                      handleInputChange(e, taskData.task_id)
                                    }
                            ...
                            {dynamicKey === "SendTwitterPost" && (
                              <div className="flex flex-col gap-3 mt-3">
                                ...
                                <div className="flex w-full gap-4 items-center">
                                  ...
                                  {!authenticate ? (
                                    <button
                                      className="w-12 lg:h-12 sm:h-10  bg-white flex justify-center items-center rounded-full curso-pointer"
                                      onClick={(e) => {
                                        Check_authentication(e);
                                      }}
                                    >
                                ...
                                {!authenticate ? (
                                  <div>
                                    <p className="text-gray-400 text-sm font-semibold">
                                      Authenticate Twitter before submitting.
                                      Click on top right icon to authenticate
                                    </p>
                                  </div>
                                ) : (
                                  <div>
                            ...
                            {dynamicKey === "SendImage" && (
                              <div className="mt-4 w-full ">
                                <div className="text-white font-semibold lg:text-md sm:text-xs">
                                  {taskData.description}
                                </div>
                                <div className="flex gap-5 my-5">
                                  <div className="text-white font-semibold lg:text-md sm:text-xs mt-4">
                                    Sample Image
                                  </div>
                                  <img
                                    src={task.sampleImg}
                                ...
                                <div className="flex flex-col gap-3 items-center justify-center rounded-lg w-full h-auto mx-auto">
                                  {task.image ? (
                                    <img
                                      ...
                                      alt="Uploaded"
                                      className="object-contain sm:max-h-64 sm:w-full h-[300px] w-[400px]"
                                    />
                                  ) : (
                                    <img
                                  ...
                                  <label className="mt-4 w-full bg-blue-500 rounded">
                                    <input
                                      ...
                                      className="hidden"
                                      onChange={(e) =>
                                        handleFileChange(e, task.task_id)
                                      }
                                    />
              ...
              {subStatus == "Unread" ? (
                ...
                >
                  {submission?.submission_id == ""
                    ? "Submit"
                    : "Update Submission"}{" "}
                  <MdOutlineArrowOutward className="ml-3" size={24} />
                </button>
              ) : (
