...
const CardDetails = () => {
  ...
  const { reward, status, title, img, social_platforms, icons } =
    updatedContest;
    ...
    >
      ...
      <div className="flex justify-center items-center lg:ml-20 sm:ml-0">
        <div className=" flex flex-col gap-8 justify-start items-start  lg:w-3/4 sm:w-full lg:p-0 sm:p-3  mt-10 h-full ">
          ...
          <div className="text-white font-poppins mb-4 max-w-[700px]">
            {updatedContest?.description}
          </div>
          <div className="w-full flex flex-col gap-6 overflow-y-auto mb-5">
            {tasks.map((task, index) => {
              ...
              return (
                <div
                  className="flex flex-col gap-3 relative rounded-xl bg-[#171717]"
                            ...
                            <div className="mt-4 w-full ">
                              ...
                              <div className="flex flex-col gap-3 items-center justify-center rounded-lg w-full h-auto mx-auto">
                                ...
                                {task.image || task.submitted ? null : (
                                  <div
                                    className=" flex flex-col items-center mt-6  justify-center gap-2 text-white "
