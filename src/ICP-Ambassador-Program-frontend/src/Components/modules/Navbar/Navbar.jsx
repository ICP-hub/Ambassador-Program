...
const Navbar = ({
  ...
  return (
    <div className=" py-2 h-[135px] px-10 z-50 sticky top-0 rounded-b-xl flex justify-between items-center mx-3 bg-[#1F1035]">
      ...
      <div className="flex items-center gap-3">
        ...
        {discordl_user ? (
          <div
            className="flex    justify-between items-center gap-2 rounded-md hover:bg-gray-700 py-1 px-1 cursor-pointer"
