...
const Navbar = ({nav,openRefModal,setLoading}) => {
  ...
  return (
    <div className='mt-4 flex justify-between items-center mx-3'>
        <div className='flex items-center gap-5  ' onClick={()=>nav('/')}>
            <div>
                <img src='atlasnew.png' alt='atlas' className='h-14'/>
            ...
            {/* <div className='lg:block sm:hidden'>
                <div className='flex border-2 hover:border-white bg-transparent py-1 text-white w-96 rounded-md gap-4 items-center px-2 border-gray-500'>
        ...
        {isSideBar && (
                <div className={`fixed top-0 right-0 h-full w-full   shadow-lg transition-transform duration-1000 ease-in-out ${isSideBar ? 'translate-x-0' : 'translate-x-full'}`} style={{backgroundColor:'#1d1d21'}}>
                            ...
                            <div className='flex flex-col items-start gap-4 mx-4 mt-4'>
                                ...
                                {discordl_user ? (
                                    ...
                                    <div className='lg:block sm:hidden'>
                                        ...
                                        style={{ boxShadow: 'rgba(255, 255, 255, 0.25) 0px 50px 100px -20px, rgba(255, 255, 255, 0.3) 0px 63px 60px -50px' }}
                                        onClick={() => setModelOpen(true)}
                                        >
                                        Log In
                                        </div>
