...
const LoginModel = ({ isOpen, onClose,isReferred }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center">
      <div className='flex lg:w-2/4 sm:w-5/6 lg:h-58 sm:h-52 justify-center items-center'>
        ...
        <div className='rounded-md hover:bg-gray-700 py-2 px-2 ml-2 self-start flex  justify-center items-center cursor-pointer' onClick={onClose}>
          <MdClose className='text-white' style={{ fontSize: '20px' }} />
        </div>
      </div>  
    </div>
