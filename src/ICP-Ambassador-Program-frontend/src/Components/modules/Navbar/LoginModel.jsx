...
const LoginModel = ({ isOpen, onClose, isReferred }) => {
  ...
  // const DISCORD_OAUTH_URL = `https://discord.com/oauth2/authorize?client_id=${DISCORD_CLIENT_ID}&response_type=code&redirect_uri=${encodeURIComponent(
  //   REDIRECT_URI
  ...
  // const handleDiscordLogin = () => {
  //   //discord.com/oauth2/authorize?client_id=1303682602825158676&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fdiscord%2Fcallback&scope=guilds.members.read+connections+email+identify
  //   https: window.location.href = DISCORD_OAUTH_URL;
  // };
