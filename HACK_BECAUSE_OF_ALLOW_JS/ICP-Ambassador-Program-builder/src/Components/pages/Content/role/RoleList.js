...
import { Autocomplete, Box, Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, IconButton, Input, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Typography, } from '@mui/material';
        ...
        {showAssignNewRoleModal && (<Dialog open onClose={handleClose}>
            ...
            <DialogContent>
              <DialogContentText>
                ...
                <AutocompleteSearchInput options={staticUserProfiles} onSelected={(user) => {
                setUserToAdd(user);
            }} noOptionsText="No users found" label="Type user name"/>
