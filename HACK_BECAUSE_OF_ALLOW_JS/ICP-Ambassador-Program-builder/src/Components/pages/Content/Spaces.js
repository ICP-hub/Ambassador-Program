...
const Spaces = ({ setLoading }) => {
    ...
    return (<div>
      <div className='flex flex-col gap-10 px-16 py-10 h-screen'>
        ...
        {spaces?.map((item, index) => (<SpaceCard item={item} handleSpace={handleSpace} key={index}/>))}
        </div>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <input type="text" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-3
                            ...
                            hover:border-black
                            focus:border-blue-500 focus:ring-blue-500" placeholder="Space name..." onChange={(e) => setNewSpace({ ...newSpace, name: e.target.value })}/>
              ...
              <div className='hidden'>
                ...
                <input type="text" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-3 
                            placeholder-gray-500
                            hover:border-black
                            focus:border-blue-500 focus:ring-blue-500" placeholder="Slug with lowercase, e.g. blocked" onChange={(e) => setNewSpace({ ...newSpace, slug: e.target.value })}/>
              ...
              <div>
                ...
                <FormControl fullWidth>
                  ...
                  <Select labelId="demo-simple-select-label" id="demo-simple-select-conv" value={newSpace.conversion} label="conversion rate" onChange={(e) => setNewSpace({ ...newSpace, conversion: parseInt(e.target.value) })}>
