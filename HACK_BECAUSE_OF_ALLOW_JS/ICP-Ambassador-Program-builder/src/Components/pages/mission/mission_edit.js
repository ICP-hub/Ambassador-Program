      ...
      <div className="flex justify-center items-center mx-auto mb-3">
        <FormControl sx={{ display: 'flex', flexDirection: 'column', gap: 2 }} className="w-5/6">
          ...
          <FormControl>
            <FormControlLabel
              control={
                <Checkbox sx={{ flexDirection: 'row-reverse', gap: 1, alignItems: 'center' }} />
              }
          ...
          <div className=''>
            ...
            {tasks.map((task, index) => (
              <DraggableTask key={task.id} index={index} task={task} moveTask={moveTask} onDelete={handleDeleteTask} />
            ))}
          </div>
