...
const LoginModel = ({ isOpen, onClose }) => {
        ...
        const checkUserData = async () => {
            try {
                ...
                if (savedUserData) {
                    ...
                    console.log("User Data from localStorage:", JSON.parse(savedUserData));
                    return;
                }
    ...
    const exchangeCodeForToken = async (code) => {
        ...
        const data = await response.json();
        console.log("Exchange data for token:", data);
    ...
    return (<div className="fixed inset-0 bg-black bg-opacity-70 flex gap-3 items-center justify-center">
